...
class Car:
    ...
    def is_priority_repair(self) -> bool:
        """Check if a car is a priority repair car in the repair queue."""
        return len(self.color + self.make) == 13
...
class Service:
    ...
    def can_add_to_service_queue(self, car: Car) -> bool:
        ...
        """
        if len(self.cars) + 1 >= self.max_car_num:
            return False
