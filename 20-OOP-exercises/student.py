...
class Student:
    ...
    def __init__(self, name: str, courses: list[str], gpa: float):
        """Student constructor."""
        self.name = name
...
def is_participating(self, course_name: str) -> bool:
    """
    Check if the student is participating in a course.

    Return true if the course name is in the list of student's courses.
    """
...
def filter_by_course(student_list: list, course: str) -> list:
    ...
    for student in student_list:
        if is_participating(student, course):
...
def sort_by_best_grade(student_list: list) -> list:
    ...
    """
    return sorted(succeeding_students(student_list), key=lambda student: student.gpa, reverse=True)
...
def sort_by_worst_grade(student_list: list) -> list:
    ...
    """
    return sorted(succeeding_students(student_list), key=lambda student: student.gpa)
