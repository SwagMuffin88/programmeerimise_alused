...
def hundred(num_a: int) -> int:
    """
    Given a positive integer num_a. If its smaller or equal to 100 return 100 - num_a. Else return the reminder from
    dividing it with 100.
...
if __name__ == '__main__':
    ...
    print(is_in_string("t", "car"))
    print(are_same_length("aa", "bbb"))
    print(is_letter_or_digit("%"))
    print(are_last_symbols_same("cat", "dog"))
    print(hundred(110))